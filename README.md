# 无视通知权限的Toast   1.1.0(Toast unaffected by notification permissions 1.1.0)  [![ToastUtils](https://jitpack.io/v/Chen-Xi-g/ToastUtils.svg)](https://jitpack.io/#Chen-Xi-g/ToastUtils)
...
##### **Step 2. Add the dependency**
 ...
 ```
implementation 'com.github.Chen-Xi-g:ToastUtils:1.1.0'
```
